                    ...
                    _load= function (key,proot,done)
                    {
                           ...
                           function (field,done)
                           {
                               ...
                               if (field.indexOf('__')==0)
                               {
                                 ...
                                 query.identity.get(_id,_pos,function (loaded)
                                 {
                                     if (loaded)
                                     {
                                         item[attr]= loaded; 
                                         ...
                                         query.table.findOne({ _id: _id },
                                                             query.toprojection(proot[attr]),
                                                             query.identity)
                                         .result(function (value)
                                         {
                                            item[attr]= value; 
                                            query.identity.set(_id,_pos,value);
                                            done();
                                         })
                                         .consumed(p.trigger.consumed)
                                         .error(_ignoreNotFound(done,_id,_pos,query));
                                 });
                               }
                               else
                               if (field=='_ref')
                                  ...
                                  if (_diff)
                                      query.identity.get(_id,_pos,function (loaded)
                                      {
                                         if (loaded)
                                         {
                                             ...
                                             query.table.findOne({ _id: _id, _pos: _pos },
                                                                   query.toprojection(proot),
                                                                   query.identity)
                                             .result(function (loaded)
                                             {
                                                item= loaded;
                                                query.identity.set(_id,_pos,loaded);
                                                done();
                                             })
                                             .consumed(p.trigger.consumed)
                                             .error(_ignoreNotFound(done,_id,_pos,query));
                                    ...
                                    item._old= cclone(item,function (field,value,clone,node,origValue,known)
                                               {
                                                   ...
                                                   if (field.indexOf('___')==0)
                                                   {
                                                      ...
                                                      if (!clone[attr])
                                                        clone[attr]= _.findWhere(known,{ _id: _id }); 
                                                      else
                                                   ...
                                                   if (field.indexOf('__')==0)
                                                   {
                                                      ...
                                                      if (!clone[attr])
                                                        clone[attr]= _.findWhere(known,{ _id: _id, _pos: 0 }); 
                                                   }
                                                   else
                                                   if (field=='_ref')
                                                   {
                                                      ...
                                                      if (!clone[attr])
                                                        clone[attr]= _.findWhere(known,{ _id: _id, _pos: _pos }); 
                                                   }
