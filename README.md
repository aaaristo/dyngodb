...
An **experiment** ([pre-alpha](http://en.wikipedia.org/wiki/Software_release_life_cycle#Pre-alpha)) to get a [MongoDB](http://www.mongodb.org/) *like* interface in front of [DynamoDB](http://aws.amazon.com/dynamodb/)
